...
`;
      ...
      const localePrompts = {
        ko: `당신은 전문 사주명리학자입니다. 위 사람의 출생 사주(생년월일시)와 양력/음력 여부, 오늘 날짜를 바탕으로 운세를 분석해주세요.
        
**분석 요소:**
- 출생 사주팔자(年柱, 月柱, 日柱, 時柱) (양력/음력 구분 필수)
- 오늘의 년월일시와의 상호작용
...
**Analysis Elements:**
- Birth Four Pillars and Eight Characters (Must account for Solar/Lunar type)
...
- NEVER use hex codes (codes starting #)
